...
const App = ({navigation}) => {
      ...
      return(
        <View style={styles.boxContain}>
          <View style={styles.content5}>
            <Text style={styles.content4}>Laugfs - 5Kg</Text>
          </View>
            <Text style={styles.content1}>** Type : Laugfs</Text>
            <Text style={styles.content}>** Weight : 5Kg</Text>
            <Text style={styles.content}>** Price : Rs.1680</Text>
    ...
    return(
      <SafeAreaView style={styles.container}>
        <Boxes/>
        <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('laufs')}>
